...
function  verinfo_vehiculo(arg){


  var urlraiz=$("#url_raiz_proyecto").val();
  var miurl =urlraiz+"/form_editar_vehiculo/"+arg+""; 
  $("#capa_modal").show();
  $("#capa_formularios").show();
  var screenTop = $(document).scrollTop();
  $("#capa_formularios").css('top', screenTop);
...
function cargar_formulario(arg){
   ...
   if(arg==4){ var miurl=urlraiz+"/form_nuevo_vehiculo"; }
   if(arg==4){ var miurl=urlraiz+"/form_bitacora"; }
...
$(document).on("submit",".formentrada",function(e){
  ...
  if(quien=="f_crear_vehiculo"){  var varurl=$(this).attr("action");  var div_resul="capa_formularios";  }
  if(quien=="f_editar_vehiculo"){  var varurl=$(this).attr("action");  var div_resul="notificacion_E2";  }
  if(quien=="f_crear_bitacora"){  var varurl=$(this).attr("action");  var div_resul="capa_formularios";  }
